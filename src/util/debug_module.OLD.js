...
if (typeof process !== 'undefined' &&
    ...
    processType = "node";
    console_wrapper = require('./console_wrapper.OLD.js');
}
...
for (i = 0; i < 5; ++i) {
    DebugLogger.prototype[log_func_name + i] = log_builder(i);
}
...
DebugLogger.prototype.set_throttle = function(is_enabled) {
    this._throttled = Boolean(is_enabled);
};
